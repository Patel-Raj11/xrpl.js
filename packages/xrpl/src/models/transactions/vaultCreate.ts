/* eslint-disable no-bitwise -- flag validation requires bitwise operations */
...
/**
 * The only defined WithdrawalPolicy strategy: first-come-first-serve. When
 * VaultCreate omits WithdrawalPolicy, rippled stores this value.
 */
...
/**
 * Map of boolean flags for a VaultCreate Transaction.
 *
 * @category Transaction Flags
 */
