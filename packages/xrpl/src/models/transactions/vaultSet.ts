...
/**
 * Updates an existing Vault object.
 *
...
export interface VaultSet extends BaseTransaction {
  ...
  VaultID: string
  /**
   * The maximum asset amount that can be held in a vault. The value cannot be
   * lower than the current AssetsTotal unless the value is 0.
   */
