...
/**
 * Compute the Hash of a Vault LedgerEntry.
 *
 * The Index of a Vault object is the SHA-512Half of the following values,
 ...
 *
 * @param address - Address of the Vault Owner.
 * @param sequence - Sequence number of the VaultCreate transaction.
 * @returns The hash of the Vault LedgerEntry.
 * @category Utilities
 */
